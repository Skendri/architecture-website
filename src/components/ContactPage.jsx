  ...
  const services = [
    {
      ...
      description:
        "Complete architectural design services from concept to construction.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Full project management services to ensure successful completion.",
      color: "from-green-500 to-emerald-500",
    },
  ];
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Ready to transform your architectural vision into reality? Our
                team of experienced architects and designers is here to guide
                you through every step of your project. Let's discuss how we can
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                ...
                comprehensive architectural services tailored to your unique
                needs.
              </p>
            </motion.div>
            ...
            >
              <div>
                ...
                <p className="text-gray-300 text-lg mb-8">
                  We believe that great architecture starts with great
                  communication. Whether you have a specific project in mind or
                  simply want to explore possibilities, we're here to listen and
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="institutional" className="bg-gray-800">
                        Institutional
                      </option>
                      <option value="mixed-use" className="bg-gray-800">
                        Mixed-Use
                      </option>
                      <option value="renovation" className="bg-gray-800">
                        Renovation
                      </option>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="under-100k" className="bg-gray-800">
                        Under $100K
                      </option>
                      <option value="100k-500k" className="bg-gray-800">
                        $100K - $500K
                      </option>
                      <option value="500k-1m" className="bg-gray-800">
                        $500K - $1M
                      </option>
                      <option value="1m-5m" className="bg-gray-800">
                        $1M - $5M
                      </option>
                      <option value="over-5m" className="bg-gray-800">
                        Over $5M
                      </option>
                    </select>
                  </motion.div>
